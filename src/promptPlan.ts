export function buildPlanPrompt(params: {
  ...
  return [
    ...
    'If a tool call fails, still plan with whatever confirmed information you already have.',
    'If nothing meaningful to test, return {"final":{"plan":[],"reason":"<brief explanation>"}}.',
    'Source:',
    codeChunk
  ].join('\n');
}
